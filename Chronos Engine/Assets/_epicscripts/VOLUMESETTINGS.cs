...
public class OptionsScript : MonoBehaviour
{
    ...
    public TMP_Text masterlabel, musiclabel, soundlabel, fullscreenlabel;
    public Slider masterslider, musicslider, soundslider, fullscreenSlider; // 0 = Windowed, 1 = Borderless, 2 = Fullscreen
