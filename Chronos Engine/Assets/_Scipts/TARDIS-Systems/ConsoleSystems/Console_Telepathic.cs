...
public class Console_Telepathic : TARDISSubsystemController
{
    ...
    [SerializeField] private TARDISEngineManager engineManager; // Crucial for accessing Stabilisers

    [Header("Input Dependencies")]
    [SerializeField] private PlayerInput playerInput;
    [SerializeField] private Console_Handbrake handbrake;
    [SerializeField] private Console_Throttle throttle;
    ...
    // NEW: Actions for the Plotter keys (these will now also trigger the adjustment)
    ...
    void Awake()
    {
        ...
        if (handbrake == null) handbrake = FindAnyObjectByType<Console_Handbrake>();
        if (throttle == null) throttle = FindAnyObjectByType<Console_Throttle>();
